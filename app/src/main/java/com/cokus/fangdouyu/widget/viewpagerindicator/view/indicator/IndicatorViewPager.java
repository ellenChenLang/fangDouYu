...
import com.cokus.fangdouyu.widget.viewpagerindicator.view.indicator.Indicator.IndicatorAdapter;
import com.cokus.fangdouyu.widget.viewpagerindicator.view.indicator.Indicator.OnTransitionListener;
import com.cokus.fangdouyu.widget.viewpagerindicator.view.indicator.slidebar.ScrollBar;
import com.cokus.fangdouyu.widget.viewpagerindicator.view.viewpager.RecyclingPagerAdapter;
...
public class IndicatorViewPager {
    ...
    public IndicatorViewPager(com.cokus.fangdouyu.widget.viewpagerindicator.view.indicator.Indicator indicator, ViewPager viewPager) {
        this(indicator, viewPager, true);
    }

    public IndicatorViewPager(com.cokus.fangdouyu.widget.viewpagerindicator.view.indicator.Indicator indicator, ViewPager viewPager, boolean indicatorClickable) {
        super();
    ...
    protected void iniOnItemSelectedListener() {
        indicatorView.setOnItemSelectListener(new com.cokus.fangdouyu.widget.viewpagerindicator.view.indicator.Indicator.OnItemSelectedListener() {
    ...
    public com.cokus.fangdouyu.widget.viewpagerindicator.view.indicator.Indicator getIndicatorView() {
