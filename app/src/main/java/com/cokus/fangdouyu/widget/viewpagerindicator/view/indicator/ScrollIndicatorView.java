...
import com.cokus.fangdouyu.widget.viewpagerindicator.view.indicator.slidebar.ScrollBar.Gravity;


/**
 * 主要用于多个tab可以进行滑动
 */
public class ScrollIndicatorView extends HorizontalScrollView implements com.cokus.fangdouyu.widget.viewpagerindicator.view.indicator.Indicator {
