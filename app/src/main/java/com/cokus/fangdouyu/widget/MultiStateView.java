...
public class MultiStateView extends FrameLayout {
    ...
    private void setView(@ViewState int previousState, String customMsg) {
        if (loadingAnimationDrawable!=null) loadingAnimationDrawable.stop();
        switch (mViewState) {
            case STATE_LOADING:
                ...
                loadingAnimationDrawable = (AnimationDrawable)((ImageView)mLoadingView.findViewById(R.id.load_img)).getBackground();
